...
kl_optim = KL_QP(model, guide, pyro.optim(optim.Adam, adam_params), analytic=True)
kl_eval = KL_QP(model=model, guide=guide, optim_step_fct=pyro.optim(optim.Adam, adam_params), num_particles=10, analytic=True)
