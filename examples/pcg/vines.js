...
var makeProgram = function() {

	var _flip = function(p, localState, name) {
		return sample(Bernoulli({p: p}));
	}

	var _discrete3 = function(p0, p1, p2, localState, name) {
	...
	var _gaussian = function (mu, sigma, localState, name) {
