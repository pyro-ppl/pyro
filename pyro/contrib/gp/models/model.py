...
class GPModel(Parameterized):
    ...
    def set_data(self, X, y=None):
        ...
        + Making a two-layer Gaussian Process stochastic function:
            ...
            >>> gpr1 = gp.models.GPRegression(X, None, kernel1, name="GPR1")  # doctest: +SKIP
            >>> Z, _ = gp_layer1.model()                                      # doctest: +SKIP
            >>> gpr2 = gp.models.GPRegression(Z, y, kernel2, name="GPR2")     # doctest: +SKIP
            >>> def two_layer_model():
            ...     Z, _ = gpr1.model()
            ...     gpr2.set_data(Z, y)
            ...     return gpr2.model()
