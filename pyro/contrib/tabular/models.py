...
class TreeCat(object):
    ...
    def model(self, data, impute=False):
        ...
        # TODO fix AutoDelta to support pyro.irange.
        # vertices_irange = pyro.irange("vertices_range", V)
        # edges_irange = pyro.irange("edges_range", E)
        vertices_irange = range(V)
        edges_irange = range(E)
        components_iarange = pyro.iarange("components_iarange", M)
