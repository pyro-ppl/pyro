...
def compute_marginals_bp(exists_logits, assign_logits, bp_iters):
    ...
    for i in range(bp_iters):
        ...
        warn_if_nan('message_e_to_a iter {}'.format(i), message_e_to_a)
        warn_if_nan('message_a_to_e iter {}'.format(i), message_a_to_e)
...
def compute_marginals_persistent_bp(exists_logits, assign_logits, bp_iters, bp_momentum=0.5):
    ...
    for i in range(bp_iters):
        ...
        warn_if_nan('message_a_to_b iter {}'.format(i), message_a_to_b)
        warn_if_nan('message_b_to_e iter {}'.format(i), message_b_to_e)
        warn_if_nan('message_e_to_b iter {}'.format(i), message_e_to_b)
        warn_if_nan('message_b_to_a iter {}'.format(i), message_b_to_a)
