...
class Distribution(object):
    ...
    **Examples**:
    ...
    def score_parts(self, x, *args, **kwargs):
        ...
        :rtype: ScoreParts
        """
        log_prob_sum = self.log_prob(x, *args, **kwargs)
        if self.reparameterized:
            return ScoreParts(log_prob_sum=log_prob_sum, score_function=0, entropy_term=log_prob_sum)
        else:
            ...
            return ScoreParts(log_prob_sum=log_prob_sum, score_function=log_prob_sum, entropy_term=0)
