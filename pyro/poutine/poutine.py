...
class Poutine(object):
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        if exc_type is None:  # callee or enclosed block returned successfully
            ...
            if self.msngr in _PYRO_STACK:
                loc = _PYRO_STACK.index(self.msngr)
