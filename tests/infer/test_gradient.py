...
from pyro.infer import (SVI, JitTrace_ELBO, JitTraceEnum_ELBO, JitTraceGraph_ELBO, Trace_ELBO, Trace_MeanFieldELBO,
...
@pytest.mark.parametrize("Elbo,local_samples,reparameterized", [
    ...
    (Trace_MeanFieldELBO, False, True),
])
