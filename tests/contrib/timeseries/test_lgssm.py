...
def test_generic_lgssm_forecast(state_dim, obs_dim, T):
    ...
    actual_loc, actual_cov = model._forecast(2, filtering_state, include_observation_noise=False)
