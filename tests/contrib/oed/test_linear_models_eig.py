...
@pytest.fixture
def linear_model():
    return known_covariance_linear_model(
        coef_means=torch.tensor(0.0),
        coef_sds=torch.tensor([1.0, 1.5]),
...
def test_lfire_linear_model(linear_model, one_point_design):
    ...
    estimated_eig = lfire_eig(
        ...
        num_steps=1200,
        classifier=make_lfire_classifier(50),
