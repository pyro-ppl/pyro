...
TEST_CASES = [
    ...
    T(VariationalGP, X, y_multiclass1D, kernel, multiclass_likelihood),
    T(VariationalGP, X, y_multiclass2D, kernel, multiclass_likelihood),
    T(VariationalGP, X, y_count1D, kernel, poisson_likelihood),
    T(VariationalGP, X, y_count2D, kernel, poisson_likelihood),
    T(VariationalSparseGP, X, y_binary1D, kernel, binary_likelihood),
    T(VariationalSparseGP, X, y_binary2D, kernel, binary_likelihood),
    T(VariationalSparseGP, X, y_multiclass1D, kernel, multiclass_likelihood),
    T(VariationalSparseGP, X, y_multiclass2D, kernel, multiclass_likelihood),
    T(VariationalSparseGP, X, y_count1D, kernel, poisson_likelihood),
