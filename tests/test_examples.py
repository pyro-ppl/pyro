...
CPU_EXAMPLES = [
    ...
    'contrib/mue/FactorMuE.py --test --small -p False -s False',
    'contrib/mue/FactorMuE.py --test --small -ard True -idfac True -sub False -p False -s False',
    'contrib/mue/ProfileHMM.py --test --small -p False -s False',
    'contrib/mue/ProfileHMM.py --test --small -L True -p False -s False',
