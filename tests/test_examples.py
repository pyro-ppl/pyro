...
CPU_EXAMPLES = [
    ...
    'contrib/mue/FactorMuE.py --test --small --no-plots --no-save',
    ...
    'contrib/mue/ProfileHMM.py --test --small -L --no-plots --no-save',
...
CUDA_EXAMPLES = [
    ...
    'contrib/mue/FactorMuE.py --test --small --no-plots --no-save --cuda',
    'contrib/mue/FactorMuE.py --test --small -ard -idfac --no-substitution-matrix --no-plots --no-save --cuda',
    'contrib/mue/ProfileHMM.py --test --small --no-plots --no-save --cuda',
    'contrib/mue/ProfileHMM.py --test --small -L --no-plots --no-save --cuda',
...
JIT_EXAMPLES = [
    ...
    'contrib/mue/FactorMuE.py --test --small --no-plots --no-save --jit',
    ...
    'contrib/mue/ProfileHMM.py --test --small -L --no-plots --no-save --jit',
