...
JIT_EXAMPLES = [
    ...
    xfail_jit('hmm.py --num-steps=1 --truncate=10 --model=1 --jit'),
    xfail_jit('hmm.py --num-steps=1 --truncate=10 --model=2 --jit'),
    xfail_jit('hmm.py --num-steps=1 --truncate=10 --model=3 --jit'),
    xfail_jit('hmm.py --num-steps=1 --truncate=10 --model=4 --jit'),
