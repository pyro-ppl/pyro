...
tr_normal.add_node("normal_0", type="sample", value=ng_zeros(1))
...
tr_normal_normal.add_node("normal_0", type="sample", value=ng_zeros(1))
...
tr_bernoulli_normal.add_node("bern_0", type="sample", value=ng_ones(1))
