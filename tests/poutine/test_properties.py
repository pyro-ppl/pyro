...
tr_normal.add_node("normal_0", type="sample", is_observed=False, value=ng_zeros(1), infer={})
...
tr_normal_normal.add_node("normal_0", type="sample", is_observed=False, value=ng_zeros(1), infer={})
...
tr_bernoulli_normal.add_node("bern_0", type="sample", is_observed=False, value=ng_ones(1), infer={})
