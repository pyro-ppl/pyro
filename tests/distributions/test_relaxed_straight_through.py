...
def test_onehot_entropy_grad(temp):
    ...
    assert_equal(
        ...
        actual,
        prec=0.08,
        msg="bad grad for RelaxedOneHotCategoricalStraightThrough (expected {}, got {})".format(expected, actual),
    )
...
def test_bernoulli_entropy_grad(temp):
    ...
    assert_equal(
        ...
        actual,
        prec=0.04,
        msg="bad grad for RelaxedBernoulliStraightThrough (expected {}, got {})".format(expected, actual),
    )
