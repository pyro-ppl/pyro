...
@pytest.mark.parameterize('L21', [0.4, 1.1])
@pytest.mark.parameterize('L11', [0.6])
@pytest.mark.parameterize('omega1', [0.5])
@pytest.mark.parameterize('sample_shape', [torch.Size([1000, 2000]), torch.Size([200000])])
@pytest.mark.parameterize('k', [1])
@pytest.mark.parameterize('mvn_dist', ['OMTMultivariateNormal', 'AVFMultivariateNormal'])
...
@pytest.mark.parameterize('L21', [0.4, 1.1])
@pytest.mark.parameterize('L11', [0.6, 0.95])
@pytest.mark.parameterize('omega1', [0.5, 0.9])
