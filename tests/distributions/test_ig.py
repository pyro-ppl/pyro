...
@pytest.mark.parameterize('concentration', [3.3, 4.0])
@pytest.mark.parameterize('rate', [2.5, 3.0])
...
@pytest.mark.parameterize('concentration', [2.5, 4.0])
@pytest.mark.parameterize('rate', [2.5, 3.0])
@pytest.mark.parameterize('value', [0.5, 1.7])
