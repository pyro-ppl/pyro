...
ARGS = {
    ...
    dist.RelaxedOneHotCategorical: [1.0, torch.ones(2)],
    dist.RelaxedOneHotCategoricalStraightThrough: [1.0, torch.ones(2)],
    dist.TransformedDistribution: [
        dist.Normal(0, 1),
        torch.distributions.ExpTransform(),
    ],
    dist.Uniform: [0, 1],
    dist.VonMises3D: [torch.tensor([1.0, 0.0, 0.0])],
}
